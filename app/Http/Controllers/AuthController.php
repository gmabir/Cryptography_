...
class AuthController extends Controller
{
    ...
    public function sendLoginOtp(Request $request)
    {
        ...
        try {
            ...
            $dataToAuthenticate = $user->login_hash . $user->encrypted_username . $user->encrypted_email . $user->password_salt . $user->hashed_password . $user->encrypted_two_factor_secret . $user->role . $approvalFlag;
    ...
    /**
     * ADMIN ONLY: Get all non-admin users (Students & Wardens) with decrypted details.
     */
